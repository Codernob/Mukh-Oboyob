...
def parse_args():
    ...
    parser.add_argument(
        "--validation_prompt", type=str, default="মেয়েটির ভ্রু কুচকানো ছিল। মেয়েটির সোনালী চুল ছিল। মেয়েটির মুখ কিছুটা খোলা ছিল। ", help="A prompt that is sampled during training for inference."
    )
    parser.add_argument(
...
def main():
    ...
    def tokenize_captions(examples, is_train=True):
        ...
        # )
        inputs = tokenizer(captions,max_length=150, return_tensors='pt', padding="max_length", truncation=True)
